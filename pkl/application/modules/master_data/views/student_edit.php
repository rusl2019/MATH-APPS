<div class="modal-content">
    <div class="modal-header">
        <h1 class="modal-title fs-5" id="showModalLabel">Edit <?php echo $title; ?></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <?php echo form_open('/master_data/student/update', ['id' => 'formEdit']); ?>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="study_program_id" name="study_program_id">
                ...
                <?php foreach ($study_programs as $study_program) : ?>
                    <option value="<?php echo $study_program['id']; ?>" <?php echo $study_program['id'] == $study_program_id ? 'selected' : ''; ?>><?php echo $study_program['name']; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        <div class="mb-3">
