...
$config = [
     ...
     */
    'auth.adminpassword' => SIMPLESAML_ADMIN_PASSWORD,
     ...
     */
    'database.dsn' => 'mysql:host=' . SIMPLESAML_DB_HOST . ';dbname=' . SIMPLESAML_DB_NAME,

    /*
     * SQL database credentials
     */
    'database.username' => SIMPLESAML_DB_USERNAME,
    'database.password' => SIMPLESAML_DB_PASSWORD,
    'database.options' => [],
     ...
     * syntaxes.
     */
    'store.sql.dsn' => 'mysql:host=' . SIMPLESAML_DB_HOST . ';dbname=' . SIMPLESAML_DB_NAME,

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => SIMPLESAML_DB_USERNAME,
    'store.sql.password' => SIMPLESAML_DB_PASSWORD,
